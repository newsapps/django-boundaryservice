...
class GeometryApiField(ApiField):
    ...
    def convert(self, value):
        ...
        # Get ready-made geojson serialization and then convert it _back_ to a
        # Python object
...
class SluggedResource(ModelResource):
    """
    ModelResource subclass that handles looking up models by slugs rather than
    IDs.
    """
    ...
    def api_field_from_django_field(cls, f, default=CharField):
        """
        Overrides default field handling to support custom ListField and
        JSONField.
        """
        ...
        return super(SluggedResource, cls).api_field_from_django_field(
            f, default)
