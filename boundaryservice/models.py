...
class BoundarySet(SluggedModel):
    ...
    singular = models.CharField(
        max_length=64, help_text='Name of a single boundary, e.g. "Community Area".'
    )
    ...
    href = models.URLField(
        blank=True, help_text="The url this data was found at, if any."
    )
...
class Boundary(SluggedModel):
    ...
    if USE_GEODJANGO:
        ...
        centroid = models.TextField(null=True, help_text="(GeoDjango is disabled)")

    class Meta:
        ordering = ("-pk", "display_name")
